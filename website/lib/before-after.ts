...
export const BEFORE_AFTER_PROJECTS: BeforeAfterProject[] = [
  {
    ...
    beforeMainAlt: "Weathered metal railing before restoration – rust, flaking paint",
    afterMainAlt: "Restored railing – freshly painted black finish",
    beforeGrid: [`${IMG}/before-2.png`, `${IMG}/before-3.png`],
    afterGrid: [`${IMG}/after-2.png`],
    beforeGridAlt: ["Railed area before – rust and wear"],
    afterGridAlt: ["Railed area after – restored"],
  },
];
