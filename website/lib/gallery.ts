...
export const GALLERY_IMAGES: GalleryImage[] = [
  // ─── Period Cottage Interior ───────────────────────────────────
  {
    ...
    alt: "Bathroom with dark navy walls and exposed beams. Walls painted in Farrow & Ball Studio Green No 93 Modern Emulsion.",
    caption: "Bathroom with dark navy walls and exposed beams. Bathroom walls painted in Farrow & Ball Studio Green No 93 Modern Emulsion.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
  {
    filename: "627934451_122155307000722526_2472349580598342324_n.jpg",
    alt: "Snug with dark navy feature wall, exposed beams and white woodwork. Walls finished in Farrow & Ball Hague Blue No 30 Modern Emulsion.",
    caption: "Dark navy feature wall with exposed beams and white woodwork. Snug walls finished in Farrow & Ball Hague Blue No 30 Modern Emulsion.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
  {
    filename: "629564978_122155306952722526_8031525408943414936_n.jpg",
    alt: "Dark navy walls with exposed beams. Hague blue walls finished in Little Greene Linen Wash Flat Eggshell.",
    caption: "Dark navy walls with exposed beams — in progress. Hague blue walls finished off with Little Greene Linen Wash Flat Eggshell.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
  {
    filename: "628471282_122155291220722526_5737546808165462698_n.jpg",
    alt: "Finished bedroom in sage green with white wardrobes. Walls in Farrow & Ball Treron No 292 Estate Emulsion.",
    caption: "Finished bedroom in sage green with white wardrobes. Completed bedroom in Farrow & Ball Treron No 292 Estate Emulsion.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
  {
    filename: "629374977_122155291178722526_1914687581078270321_n.jpg",
    alt: "Sage green bedroom — different angle showing window detail. Walls in Treron; woodwork in Little Greene Linen Wash Flat Eggshell.",
    caption: "Sage green bedroom — different angle showing window detail. Finished walls in Treron complemented with Little Greene Linen Wash Flat Eggshell on all woodwork.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
  {
  ...
  },
  {
    ...
    alt: "Window detail — white painted reveal with oak lintel. Window in Farrow & Ball Pointing No 2003; sill in Sikkens varnish.",
    caption: "Window detail — white painted reveal with oak lintel. Window painted in Farrow & Ball Pointing No 2003; windowsill board coated in Sikkens varnish.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
  ...
  // ─── Georgian Exterior in Bath ─────────────────────────────────
  {
    ...
    alt: "Finished Georgian front door in teal green with fanlight. Door in Dulux Weathershield Oil Based Exterior High Gloss; porch surround in Sandtex Smooth Masonry White.",
    caption: "Finished Georgian front door in teal green with fanlight. Finished front door painted in Dulux Weathershield Oil Based Exterior High Gloss. Porch surround painted in Sandtex Smooth Masonry White.",
    category: "Exterior",
