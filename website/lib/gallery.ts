...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  },
  {
    ...
    alt: "Finished walls in Treron complemented with Little Greene Linen Wash Flat Eggshell on all woodwork.",
    caption: "Finished walls in Treron complemented with Little Greene Linen Wash Flat Eggshell on all woodwork.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
  {
  ...
  },
  {
    ...
    alt: "Window in Farrow & Ball Pointing No 2003; sill in Sikkens varnish.",
    caption: "Window painted in Farrow & Ball Pointing No 2003; windowsill board coated in Sikkens varnish.",
    category: "Interior",
    project: "Period Cottage Interior",
  },
