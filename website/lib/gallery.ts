...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  {
    filename: "wrought-iron-gates-before-repaint.webp",
    alt: "Pair of wrought iron driveway gates in faded light blue before repainting",
    caption: "Before — driveway gates in Warleigh in tired, faded light blue.",
    category: "Exterior",
  ...
  },
  {
    ...
    alt: "Wrought iron gate part-repainted, top rail in black over the original blue finish",
    caption: "In progress — the top rail cut in, black going on over the old blue.",
    category: "Exterior",
    project: "Wrought Iron Gates & Railings",
    location: "Warleigh",
    tag: "in progress",
  ...
  {
    filename: "wrought-iron-railings-repainted.webp",
    alt: "Restored wrought iron railings in black overlooking a country garden",
    caption: "After — the full run of railings at Warleigh stripped back, treated and repainted.",
    category: "Exterior",
    project: "Wrought Iron Gates & Railings",
    location: "Warleigh",
    tag: "after",
